using LinqKit;
using Mickleball.Application.Features.Positions.Queries.GetPositions;
using Mickleball.Application.Interfaces;
using Mickleball.Application.Interfaces.Repositories;
using Mickleball.Application.Parameters;
using Mickleball.Domain.Entities;
using Mickleball.Infrastructure.Persistence.Contexts;
using Mickleball.Infrastructure.Persistence.Repository;
...
namespace Mickleball.Infrastructure.Persistence.Repositories
{
